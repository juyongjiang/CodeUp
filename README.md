...
However, the latest CodeUp-7B model (`codeup-peft-llama-2`) was fine-tuned on a single NVIDIA GeForce RTX 3090 24GB memory on July 28 for 24 hours with the following command:
...
| -- | -- |
| <center><img src="./assets/train_loss.svg" width="100%"></center>  | <center><img src="./assets/eval_loss.svg" width="100%"></center> | 
...
```
@misc{codeup,
  author = {Juyong Jiang, Jiasi Shen, and Sunghun Kim},
